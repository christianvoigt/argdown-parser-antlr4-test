...
var ruleNames =  [ "tests", "singleStatement", "relations", "incomingSupport", 
                   "incomingAttack", "outgoingSupport", "outgoingAttack", 
                   "statement", "argumentTitleDefinition", "argumentTitle", 
                   "statementTitleDefinition", "statementTitle", "tag", 
                   "string" ];
...
ArgdownParser.RULE_singleStatement = 1;
ArgdownParser.RULE_relations = 2;
ArgdownParser.RULE_incomingSupport = 3;
ArgdownParser.RULE_incomingAttack = 4;
ArgdownParser.RULE_outgoingSupport = 5;
ArgdownParser.RULE_outgoingAttack = 6;
ArgdownParser.RULE_statement = 7;
ArgdownParser.RULE_argumentTitleDefinition = 8;
ArgdownParser.RULE_argumentTitle = 9;
ArgdownParser.RULE_statementTitleDefinition = 10;
ArgdownParser.RULE_statementTitle = 11;
ArgdownParser.RULE_tag = 12;
ArgdownParser.RULE_string = 13;
...
TestsContext.prototype.singleStatement = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
ArgdownParser.prototype.tests = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while(_la===ArgdownParser.T__3 || _la===ArgdownParser.CHAR);
    } catch (re) {
...
function SingleStatementContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = ArgdownParser.RULE_singleStatement;
    return this;
}
...
SingleStatementContext.prototype.EMPTYLINE = function() {
    return this.getToken(ArgdownParser.EMPTYLINE, 0);
};
...
ArgdownParser.SingleStatementContext = SingleStatementContext;

ArgdownParser.prototype.singleStatement = function() {

    var localctx = new SingleStatementContext(this, this._ctx, this.state);
    this.enterRule(localctx, 2, ArgdownParser.RULE_singleStatement);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 33;
        ...
        this.state = 34;
        _la = this._input.LA(1);
        if(!(_la===ArgdownParser.EOF || _la===ArgdownParser.EMPTYLINE)) {
...
ArgdownParser.prototype.relations = function() {
    ...
    this.enterRule(localctx, 4, ArgdownParser.RULE_relations);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 36;
...
ArgdownParser.prototype.incomingSupport = function() {
    ...
    this.enterRule(localctx, 6, ArgdownParser.RULE_incomingSupport);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 47;
...
ArgdownParser.prototype.incomingAttack = function() {
    ...
    this.enterRule(localctx, 8, ArgdownParser.RULE_incomingAttack);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 50;
...
ArgdownParser.prototype.outgoingSupport = function() {
    ...
    this.enterRule(localctx, 10, ArgdownParser.RULE_outgoingSupport);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 53;
...
ArgdownParser.prototype.outgoingAttack = function() {
    ...
    this.enterRule(localctx, 12, ArgdownParser.RULE_outgoingAttack);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 56;
...
ArgdownParser.prototype.statement = function() {
    ...
    this.enterRule(localctx, 14, ArgdownParser.RULE_statement);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 64;
...
ArgdownParser.prototype.argumentTitleDefinition = function() {
    ...
    this.enterRule(localctx, 16, ArgdownParser.RULE_argumentTitleDefinition);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 69;
        this.argumentTitle();
...
ArgdownParser.prototype.argumentTitle = function() {
    ...
    this.enterRule(localctx, 18, ArgdownParser.RULE_argumentTitle);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 72;
...
ArgdownParser.prototype.statementTitleDefinition = function() {
    ...
    this.enterRule(localctx, 20, ArgdownParser.RULE_statementTitleDefinition);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 76;
        this.statementTitle();
...
ArgdownParser.prototype.statementTitle = function() {
    ...
    this.enterRule(localctx, 22, ArgdownParser.RULE_statementTitle);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 79;
...
ArgdownParser.prototype.tag = function() {
    ...
    this.enterRule(localctx, 24, ArgdownParser.RULE_tag);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 83;
...
ArgdownParser.prototype.string = function() {
    ...
    this.enterRule(localctx, 26, ArgdownParser.RULE_string);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 90; 
